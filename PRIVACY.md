...
如对本政策、数据删除或隐私选择有疑问，请通过 [GitHub Issues](https://github.com/AaronXu-Lab/SealNote/issues) 联系开发者。请勿在公开 Issue 中提交笔记正文、密钥或其他敏感信息。
...
For privacy questions, deletion guidance, or privacy choices, contact the developer through [GitHub Issues](https://github.com/AaronXu-Lab/SealNote/issues). Do not include note content, encryption keys, or other sensitive information in a public issue.
